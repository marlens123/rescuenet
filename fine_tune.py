...
# hyperparameters
parser.add_argument("--path_to_config", default="config/att_unet_2epochs.json", type=str, help="Path to config file that stores hyperparameter setting. For more information see 'config/README.md'.")
